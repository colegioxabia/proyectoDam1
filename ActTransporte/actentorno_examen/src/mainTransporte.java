...
/**
 * 
 * Metodo que imprime toda la tabla de trayectos del array
 */
 ...
 */
			...
			double sumaTotal=0;//Nodo 8
			int cont=0;//Nodo 8
			for (int j = 0; j < trayec.length; j++){ //Nodo 9 
				if(trayec[j]!=null)//Nodo 10
					sumaTotal+=trayec[j].getKm();
				cont ++;
			}
		
			
		System.out.println("La media de los trayectos es:"+df.format(sumaTotal/cont));//Nodo 11
}//fin del metodo
 ...
 */
	...
	public static void main(String[] args) {
		 ...
		 trayec[4]=t5;
		 trayec[5]=t6;
		 imprimirTransporte();//llamada al metodo.
		 estadisticasTransporte();// llamada al metodo.
