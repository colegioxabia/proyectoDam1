 ...
 */
		...
		public boolean esComplementario(Transporte t){
			...
			boolean buscar=false;//Nodo 1
			
			
			
	 			if((this.inici.equalsIgnoreCase(t.getDestino())) && (this.destino.equalsIgnoreCase(t.getInici()))){//Nodo 2
						
					buscar=true;//Nodo 3
			}
			return buscar;//Nodo 4
		}
}//Fin de la clase Transporte, nodo 5
